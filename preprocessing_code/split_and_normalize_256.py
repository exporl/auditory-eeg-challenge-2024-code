...
if __name__ == "__main__":
    ...
    processed_eeg_folder = os.path.join(config["dataset_folder"],config['derivatives_folder'], f"{config['preprocessed_eeg_folder']}_64")
    processed_stimuli_folder = os.path.join(config["dataset_folder"],config['derivatives_folder'], f"{config['preprocessed_stimuli_folder']}_64")
    split_data_folder = os.path.join(config["dataset_folder"],config['derivatives_folder'], config["split_folder_64"])
