...
def dilation_model_2_MM(
    ...
    # Classification
    out = tf.keras.activations.softmax((tf.keras.layers.Concatenate()([cos1_proj, cos2_proj, cos3_proj])))


    model = tf.keras.Model(inputs=[eeg, env1, env2, env3], outputs=[out])
